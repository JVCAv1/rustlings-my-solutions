...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        ...
        if      &tuple.0 > &255 || &tuple.0 < &0 { return Err(IntoColorError::IntConversion); }
        else if &tuple.1 > &255 || &tuple.1 < &0 { return Err(IntoColorError::IntConversion); }
        else if &tuple.2 > &255 || &tuple.2 < &0 { return Err(IntoColorError::IntConversion); }
        else {
            Ok(Color {
